defmodule Gateway.FriendsTest do
  ...
  describe "friends" do
    ...
    @valid_attrs %{ame: "some ame"}
    @update_attrs %{ame: "some updated ame"}
    @invalid_attrs %{ame: nil}
    ...
    test "update_friend/2 with valid data updates the friend" do
      ...
      assert friend.ame == "some updated ame"
    end
